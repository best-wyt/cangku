...
public class BusinessCacheAspect {
	...
	// 声明切面表达式
	private static final String POINTCUT_CUSTOMER_ADD = "execution(* com.wang.bus.service.impl.CustomerServiceImpl.save(..))";
	private static final String POINTCUT_CUSTOMER_UPDATE = "execution(* com.wang.bus.service.impl.CustomerServiceImpl.updateById(..))";
	private static final String POINTCUT_CUSTOMER_GET = "execution(* com.wang.bus.service.impl.CustomerServiceImpl.getById(..))";
	private static final String POINTCUT_CUSTOMER_DELETE = "execution(* com.wang.bus.service.impl.CustomerServiceImpl.removeById(..))";
	private static final String POINTCUT_CUSTOMER_BATCHDELETE = "execution(* com.wang.bus.service.impl.CustomerServiceImpl.removeByIds(..))";
	...
	// 声明切面表达式
	private static final String POINTCUT_PROVIDER_ADD = "execution(* com.wang.bus.service.impl.ProviderServiceImpl.save(..))";
	private static final String POINTCUT_PROVIDER_UPDATE = "execution(* com.wang.bus.service.impl.ProviderServiceImpl.updateById(..))";
	private static final String POINTCUT_PROVIDER_GET = "execution(* com.wang.bus.service.impl.ProviderServiceImpl.getById(..))";
	private static final String POINTCUT_PROVIDER_DELETE = "execution(* com.wang.bus.service.impl.ProviderServiceImpl.removeById(..))";
	private static final String POINTCUT_PROVIDER_BATCHDELETE = "execution(* com.wang.bus.service.impl.ProviderServiceImpl.removeByIds(..))";
	...
	//商品数据的缓存 声明切面表达式
		private static final String POINTCUT_GOODS_ADD = "execution(* com.wang.bus.service.impl.GoodsServiceImpl.save(..))";
		private static final String POINTCUT_GOODS_UPDATE = "execution(* com.wang.bus.service.impl.GoodsServiceImpl.updateById(..))";
		private static final String POINTCUT_GOODS_GET = "execution(* com.wang.bus.service.impl.GoodsServiceImpl.getById(..))";
		private static final String POINTCUT_GOODS_DELETE = "execution(* com.wang.bus.service.impl.GoodsServiceImpl.removeById(..))";
